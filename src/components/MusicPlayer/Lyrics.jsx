                ...
                {activeTab === 'lyrics' ? (
                    ...
                    <div>
                        <div className=' flex justify-between mt-4' onClick={(e)=>e.stopPropagation()}>
                            ...
                            <label htmlFor='autoAdd' className="relative inline-flex items-center mb-1 cursor-pointer mr-4">
                                <input onChange={
                                    (e) => {
                                        handleAutoAdd(e.target.checked)
                                    }
                                } type="checkbox" defaultChecked={autoAdd} className="sr-only peer" name='autoAdd' id='autoAdd' placeholder=''>
                                </input>
